    ...
    <main>
        ...
        <div class="card-group">
            <div class="card">
                ...
                <img class="icon" src="./images/whats-nearby.svg" alt="icon">
                <p>Click here to see the nearby places you can visit!</p>
            </div>
            <div class="card">
                <h3>Upcoming Events</h3>
                <img class="icon" src="./images/upcoming-events.svg" alt="icon">
                <p>Click here to see the upcoming events in the park!</p>
            </div>
            <div class="card">
                <h3>Function Hire</h3>
                <img class="icon" src="./images/function-hire.svg" alt="icon">
